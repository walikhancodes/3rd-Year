...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E>{
    ...
    protected static class Node<E> implements Position<E>{
        ...
        private Node<E> parent;     //a reference to the parent node(null if none)
    ...
    protected Node<E> validate(Position<E> p) throws IllegalArgumentException{
        ...
        if(node.getParent() == node) throw new IllegalArgumentException("p is no longer in the tree");       //defunct node will point to itelf
        return node;
    }
    ...
    //**Returns the root Position of the tree or null if the tree is empty */
    ...
    //** Returns the Position of p's left child or null if p does not have left child */
    ...
    //** Returns the Position of p's right child or null if p does not have right child */
    ...
    //** Replaces the element at Position p with e and returns the replaces element */
